...
## Current stage
STAGE 1 — THE PLAN (no application code yet)
...
## Next step
STEP 4 — `18-phases.md`, `19-decisions-required.md`, full consistency review, then your answers to the decisions. Waiting for you to type "continue".

## Open decisions so far
D-01 to D-61 (listed at the end of each PRP file; the full grouped list comes in Step 4).
